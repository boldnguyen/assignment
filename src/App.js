        ...
        <nav className="navbar navbar-static-top" role="navigation">
          ...
          <div className="myenv-location">
            ...
            <div className="myenv-locationname">
              ...
              <span className="myenv-selectlocation">
                {this.state.cityName}
              </span>
              <span
                className="glyphicon glyphicon-chevron-down down-top"
                aria-hidden="true"
              ></span>
            </div>
          </div>
        ...
        <section className="sidebar">
          <ul className="sidebar-menu">
            <li className="active treeview">
              <a href="#">
                <i className="menu"></i> <span>Menu</span>
      ...
      <div className="env-weather">
        ...
        <div className="env-weatherright">
          ...
          <div className="env-weatherdata">
            <img
              className="env-weatherdata-tem"
              src={"./img/temperature.png"}
            />
            <span>29.2℃</span>
            <img className="env-weatherdata-wat" src={"./img/water.png"} />
            <span>73%</span>
          </div>
        </div>
      </div>
  ...
  render() {
    return (
      ...
      <div className="env-item env-item-add">
        ...
        <div className="env-item-addword">Add</div>
       </a>
      </div>
    );
  }
